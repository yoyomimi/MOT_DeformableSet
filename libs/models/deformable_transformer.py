...
class DeformableMatchTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 num_encoder_layers=6, num_decoder_layers=6, dim_feedforward=1024, dropout=0.1,
                 activation="relu", return_intermediate_dec=False,
                 num_feature_levels=4, dec_n_points=4,  enc_n_points=4,
        ...
        match_decoder_layer = DeformableTransformerDecoderLayer(d_model, dim_feedforward,
                                                          dropout, activation,
                                                          num_feature_levels, nhead, dec_n_points)
        self.match_decoder = DeformableTransformerDecoder(match_decoder_layer, num_match_decoder_layers, return_intermediate_dec)
...
def build_deforamble_transformer(cfg):
    return DeformableMatchTransformer(
